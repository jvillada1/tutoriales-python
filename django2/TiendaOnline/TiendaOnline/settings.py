...
SECRET_KEY = 'django-insecure-=mt8_!n1+dyoi9=r)v#y+%us2_45!%v7&halysf5onxs3u8reb'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', #cambiamos el engine para trabajar con postgresql
        'NAME': 'articulosClientes', #nombre de la base de datos
        'USER': 'postgres', 
        'PASSWORD':'admin', 
        'HOST': '127.0.0.1', 
        'DATABASE_PORT':'5432', 
        #DESPUES SE HACE EL MISMO PROCESO QUE SE HIZO CON SQLITE, TODOS LOS COMANDOS
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp-mail.hotmail.com'
EMAIL_HOST_USER = "encallejone@hotmail.com"
EMAIL_HOST_PASSWORD = "trollface475" 
"""