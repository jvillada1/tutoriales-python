...
SECRET_KEY = 'django-insecure-h4+-xurytmgv&-35w38)h&b-tzgs)uhnz_yykwr!!&0!*4j_un'
...
DATABASES = DATABASES = {
    'default': {
        ...
        'NAME': 'servicios', #nombre de la base de datos
        'USER': 'postgres', 
        'PASSWORD':'admin', 
        'HOST': '127.0.0.1', 
        'DATABASE_PORT':'5432', 
...
MEDIA_URL='/media/' #carpeta media para imagenes y videos 
